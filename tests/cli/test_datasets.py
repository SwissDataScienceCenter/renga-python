...
def test_repository_file_to_dataset(runner, client_with_datasets_provenance, subdirectory, use_graph):
    """Test adding a file from the repository into a dataset."""
    # create a dataset
    client = client_with_datasets_provenance
...
@pytest.mark.parametrize("use_graph", [False, True])
def test_datasets_provenance_after_create(runner, client_with_datasets_provenance, use_graph):
    ...
    dataset = next(client_with_datasets_provenance.datasets_provenance.get_by_name("my-data"))
...
def test_datasets_provenance_not_updated_after_same_add(
    runner, client_with_datasets_provenance, directory_tree, use_graph
):
    ...
    datasets = list(client_with_datasets_provenance.datasets_provenance.get_by_name("my-data"))
...
def test_datasets_provenance_get_latest(runner, client_with_datasets_provenance, directory_tree):
...
def test_datasets_provenance_add_file(runner, client_with_datasets_provenance, directory_tree):
    """Test getting last dataset mutation."""
